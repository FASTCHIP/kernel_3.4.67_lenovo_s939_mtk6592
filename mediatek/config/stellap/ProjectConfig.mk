...
# @lenovo-changed
CUSTOM_HAL_MAIN_IMGSENSOR=ov8825sunny_mipi_raw
#lenovo.sw wangsx3 20131112 config main imgsensor
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = ov8825qtech_mipi_raw
...
CUSTOM_KERNEL_ALSPS=rpr410_stella
...
# @lenovo-changed
CUSTOM_KERNEL_IMGSENSOR=ov8825sunny_mipi_raw ov8825qtech_mipi_raw ov9760_mipi_raw
...
# @lenovo-changed
CUSTOM_KERNEL_LENS=dw9718af dw9718qtaf dummy_lens
...
# @lenovo-changed
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR=ov8825qtech_mipi_raw

# lens driver config for main camera (2nd solution)
CUSTOM_KERNEL_MAIN_BACKUP_LENS=dw9718qtaf

# Kernel space image sensor driver:Main camera (rear camera) used sensor driver.Value is used main sensor name.
CUSTOM_KERNEL_MAIN_IMGSENSOR=ov8825sunny_mipi_raw
...
CUSTOM_KERNEL_TOUCHPANEL=S7020_stellap #GT9XX
...
CUSTOM_LK_LCM=hx8394a_hd720_dsi_vdo_tianma_stellap nt35521_hd720_dsi_vdo_boe_stellap
...
# liubin modified 2013.03.03, disable MTK_BT_PROFILE_MANAGER
...
#lenovo-sw zhouwl, 2014-02-27, dual-mic@s939
...
#lenovo-sw weiweij added for HIGH_BATTERY_VOLTAGE_SUPPORT define
HIGH_BATTERY_VOLTAGE_SUPPORT = yes
#lenovo-sw weiweij added for HIGH_BATTERY_VOLTAGE_SUPPORT define end
#lenovo-sw weiweij added for poweroff charging ui define
LENOVO_POWEROFF_CHARGING_UI = yes
#lenovo-sw weiweij added for poweroff charging ui define end
...
#lenovo-sw zhouwl, 2014-02-27, depend on dual-mic
...
#Begin, lenovo-sw wangxf14 modify 20140113, modify for lenovo old ums project
MTK_SHARED_SDCARD=no
#End, lenovo-sw wangxf14 modify 20140113, modify for lenovo old ums project
...
#lenovo-sw chenjian2 modify on 20140304
...
RESOURCE_OVERLAY_SUPPORT=generic sd_ex
...
#lenovo-sw jixj 2014.2.27 modified
CUSTOM_MODEM=mt6592_demo_hspa_gemini_sky_1
...
CUSTOM_KERNEL_LCM=hx8394a_hd720_dsi_vdo_tianma_stellap nt35521_hd720_dsi_vdo_boe_stellap

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=hx8394a_hd720_dsi_vdo_tianma_stellap nt35521_hd720_dsi_vdo_boe_stellap
...
#CREATE_PROJECT_INFO=20140220215928
MTK_BUILD_VERNO = ALPS.KK1.MP1.V2.10

#lenovo-sw wengjun1 2013.10.21 add begin
LENOVO_CTP_SLIDE_WAKEUP = yes
LENOVO_BSP_SIDE_KEY_WAKEUP = yes
LENOVO_AREA_TOUCH = yes
LENOVO_CTP_TEST_FLUENCY = no
#lenovo-sw wengjun1 2013.10.21 add end

#lenovo.sw2 houdz 20130214 add:support  "Multi Gamma" and "PQ"function
LENOVO_LCM_MULTI_GAMMA_PQ = yes
CUSTOM_PQ_GAMMA_VER = project_stellap


#lenovo.sw2 houdz 2014-01-23 add :support lenovo backlight 
LENOVO_BACKLIGHT_LIMIT = yes

#lenovo.sw2 houdz 2014-01-23 add :support  "lcm cabc" 
LENOVO_LCD_BACKLIGHT_CONTROL_BY_LCM = no
...
#Lenovo-sw yexh1 LENOVO_USB_STANDARD add, 2013-9-17
LENOVO_PRODUCT_DEVICE = S939
#Lenovo-sw yexh1 LENOVO_USB_STANDARD end

#lenovo-sw zhouwl, 2014-02-27 add begin
DRC_2_0_EARPHONE_SUPPORT = yes
#lenovo-sw zhouwl, 2013-02-27 add end
...
#lenovo-sw molg1 2014.0306 add begin
BOSH_BMC056_SENSOR = yes
#lenovo-sw molg1 2014.0306 add end
