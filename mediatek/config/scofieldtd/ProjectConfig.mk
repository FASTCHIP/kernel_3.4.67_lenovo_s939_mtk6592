...
CUSTOM_KERNEL_TOUCHPANEL = GT9158
...
CUSTOM_LK_LCM=nt35521_hd720_dsi_vdo_cmi otm1283a_hd720_dsi_vdo_boe_5_0inch
...
# leonovo-sw zhanghy15 modified 2014.03.06, switch the macro MTK_DATAUSAGE_SUPPORT on after the platform upgrade when 2014.2.27
...
#Lenovo-sw linyf modify 2014-01-07 12:18 , enable common slot func.
...
# MTK_FLIGHT_MODE_POWER_OFF_MD is used to control if modem is powered off when entering flight mode MTK_TELEPHONY_MODE is used for specify current telephony mode MTK_FIRST_MD is used to specify the high priority modem
#Lenovo-sw linyf modify 2014-4-11 10:28 , modify telephony_mode as TG/G gemini follow KK1.MP1 release note.
...
RESOURCE_OVERLAY_SUPPORT = generic sd_in
...
CUSTOM_MODEM=lenovo82_wet_jb5_hspa_scofieldtd
...
#lenovo-sw wuzb1 2013-06-29 set to hd720
#BOOT_LOGO=cu_qhd
BOOT_LOGO = hd720
...
LENOVO_PRODUCT_DEVICE = S850t
#lenovo yexh1 end

#lenovo jixu add sn319x rgb led
LENOVO_SN3193_SUPPORT = yes
...
DRC_2_0_SPK_EARPHONE_SUPPORT = yes
#lenovo-sw zhouwl 2014-01-06 for audio DRC2.0
#lenovo-sw jixu add begin
LENOVO_LCD_BACKLIGHT_CONTROL_BY_LCM = no
LENOVO_LCD_BACKLIGHT_COMPATIBLE_SUPPORT = yes
