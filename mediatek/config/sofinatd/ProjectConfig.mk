...
CUSTOM_HAL_IMGSENSOR = ov8825_mipi_raw_2lane sp0a19_yuv
...
#Lenovo-sw chenlj2 modify for msensor
...
#Lenovo-sw chenlj2 modify for Gsensor
# accelerometer sensor to detect accelerometer from x y z axis.
CUSTOM_KERNEL_ACCELEROMETER = bma2xx_sofina
...
CUSTOM_KERNEL_IMGSENSOR = ov8825_mipi_raw_2lane sp0a19_yuv
...
#lenovo-sw zhangjiano 2013.06.13
...
#Lenovo-sw wengjun1 modify for sofina touchpanel
# touch driver  need to report correct touch axes
CUSTOM_KERNEL_TOUCHPANEL=GT915 #GT9XX
...
# Lenovo-sw yexm1 modify, 20140108
# To choose LK LCM driver name
CUSTOM_LK_LCM = hx8389b_qhd_dsi_vdo_tianma_4_7_sofinatd nt35517_qhd_dsi_vdo_yassy
...
#Lenovo-sw linyf modify 2014-1-8 17:28 , Disable DRM func.
...
#lenovo-sw weiweij modified for bq24250 support
...
# Lenovo-sw zhuyg  fix: 3G display in lock screen,  2013-10-06 16:20 begin
# yes: turn on this feature
# no:  turn off this feature
#MTK_NETWORK_TYPE_ALWAYS_ON=no
MTK_NETWORK_TYPE_ALWAYS_ON=yes
# Lenovo-sw zhuyg  fix: 3G display in lock screen,  2013-10-06 16:20 end
...
# Lenovo-sw zhuyg  delete omacp,  2013-10-02 10:20 begin
...
# Lenovo-sw zhuyg  delete omacp,  2013-10-02 10:20 end
...
#Lenovo-sw linyf modify 2014-01-03 13:28 , change modem folder for Sofinatd.
#CUSTOM_MODEM = mt6582_demo_hspa_sky_18
CUSTOM_MODEM = lenovo82_wet_jb5_hspa_sofinatd
...
#lenovo-sw wuzb1 2013-06-29 set to qhd
#BOOT_LOGO=cu_qhd
BOOT_LOGO = qhd

# Lenovo-sw yexm1 modify, 20140108
# To choose kernel LCM driver name
#CUSTOM_KERNEL_LCM=nt35521_hd720_dsi_vdo_cmi otm1283a_hd720_dsi_vdo_boe_5_0inch
CUSTOM_KERNEL_LCM = hx8389b_qhd_dsi_vdo_tianma_4_7_sofinatd nt35517_qhd_dsi_vdo_yassy
# To choose uboot LCM driver name
#CUSTOM_UBOOT_LCM=nt35521_hd720_dsi_vdo_cmi otm1283a_hd720_dsi_vdo_boe_5_0inch
CUSTOM_UBOOT_LCM = hx8389b_qhd_dsi_vdo_tianma_4_7_sofinatd nt35517_qhd_dsi_vdo_yassy
...
#lenovo-sw jixj 2013.6.12 add end
#
#leovo-sw zhouwl, 2013-07-10, add for earphone
LENOVO_COMPATIBLE_DVT_EARPHONE = yes
#lenovo-sw chenyb1 2014.1.16 add begin
LENOVO_LOWBAT_PWROFF_ALARM = no
#lenovo-sw chenyb1 2014.1.16 add end
#lenovo-sw chenlj2 2014.3.4 add for bma222e
BOSCH_BMA222EF_SENSOR = yes 
#lenovo-sw2 houdz1 add for backlight 20140317
LENOVO_BACKLIGHT_LIMIT =yes

#lenovo-sw zhouwl 2014-01-08 for audio DRC2.0
DRC_2_0_SPK_SUPPORT = yes
#lenovo-sw zhouwl 2014-01-08 for audio DRC2.0
#lenovo-sw zhouwl 2014-01-08 for earphone pa
LENOVO_USE_HP_CODEC = yes
#lenovo-sw zhouwl 2014-01-08 for earphone pa
