...
void SP0A19NightMode(kal_bool bEnable)
{
   ...
   SP0A19_CurrentStatus.iNightMode = bEnable;
	   ...
	   if(SP0A19_MPEG4_encode_mode == KAL_TRUE)
		{
				if(sp0a19_isBanding== 0)
				{
					...
					SP0A19_write_cmos_sensor(0x04,0xec);	
				...
				else if(sp0a19_isBanding == 1)
				{
					...
					SP0A19_write_cmos_sensor(0x04,0x0d);
	    ...
	    {  
			       if(sp0a19_isBanding== 0)
					...
					//SP0A19_write_cmos_sensor(0x04,0x32);
					 ...
					 SP0A19_write_cmos_sensor(0x04,0x60);
				...
				else if(sp0a19_isBanding== 1)
				{
					...
					SP0A19_write_cmos_sensor(0x03,0x06); 
					SP0A19_write_cmos_sensor(0x04,0xa4);
	...
	else    // daylight mode
	{
				...
				SP0A19_write_cmos_sensor(0xb2,0x18);
				SP0A19_write_cmos_sensor(0xb3,0x1f);
	         ...
	         if(SP0A19_MPEG4_encode_mode == KAL_TRUE)
	          {
				if(sp0a19_isBanding== 0)
				{
					...
					SP0A19_write_cmos_sensor(0x03,0x01); 
					SP0A19_write_cmos_sensor(0x04,0xf8);
				...
				else if(sp0a19_isBanding == 1)
				{
					...
					SP0A19_write_cmos_sensor(0x03,0x01);
					SP0A19_write_cmos_sensor(0x04,0xe0); 					
			...
			else 
			{
				if(sp0a19_isBanding== 0)
				{
					...
					SP0A19_write_cmos_sensor(0x03,0x03);
					SP0A19_write_cmos_sensor(0x04,0xfc);				
					...
					//Status 
					SP0A19_write_cmos_sensor(0xfd,0x01);
					SP0A19_write_cmos_sensor(0xce,0xfc);
					SP0A19_write_cmos_sensor(0xcf,0x03);
					SP0A19_write_cmos_sensor(0xd0,0xfc);
...
{  
	  ...
	  SP0A19_write_cmos_sensor(0x30,0x00);
                ...
                /*Lenovo-sw chenglong1 modify for Aux sub cam preview mirror&flip begin*/
	...
	SP0A19_write_cmos_sensor(0xfd,0x00);
	  ...
	  //lsc  for st 
	  SP0A19_write_cmos_sensor(0xfd,0x01);    
	  SP0A19_write_cmos_sensor(0x35,0x2a);//22
	  SP0A19_write_cmos_sensor(0x36,0x22);//20
	  SP0A19_write_cmos_sensor(0x37,0x17);//1c
	  SP0A19_write_cmos_sensor(0x38,0x1c);//19
	  SP0A19_write_cmos_sensor(0x39,0x2a);//1d
	  SP0A19_write_cmos_sensor(0x3a,0x1f);//19
	  SP0A19_write_cmos_sensor(0x3b,0x17);//15
	  SP0A19_write_cmos_sensor(0x3c,0x17);//13
	  SP0A19_write_cmos_sensor(0x3d,0x2a);//1b
	  SP0A19_write_cmos_sensor(0x3e,0x1f);//17
	  SP0A19_write_cmos_sensor(0x3f,0x17);//14
	  SP0A19_write_cmos_sensor(0x40,0x1e);//15
	  SP0A19_write_cmos_sensor(0x41,0x29);//10
	  SP0A19_write_cmos_sensor(0x42,0x26);//04
	  SP0A19_write_cmos_sensor(0x43,0x2c);//04
	  SP0A19_write_cmos_sensor(0x44,0x26);//00
	  SP0A19_write_cmos_sensor(0x45,0x26);//10
	  SP0A19_write_cmos_sensor(0x46,0x26);//04
	  SP0A19_write_cmos_sensor(0x47,0x26);//04
	  SP0A19_write_cmos_sensor(0x48,0x26);//08
	  SP0A19_write_cmos_sensor(0x49,0x1a);//08
	  SP0A19_write_cmos_sensor(0x4a,0x24);//04
	  SP0A19_write_cmos_sensor(0x4b,0x26);//04
	  SP0A19_write_cmos_sensor(0x4c,0x26);//00
	...
	//SP0A19_write_cmos_sensor(0x12,0x14);
	  ...
	  SP0A19_write_cmos_sensor(0x18,0x2c);	//0x29	 0813
	...
	//d65
	  SP0A19_write_cmos_sensor(0x65,0xbb); //d5
	  SP0A19_write_cmos_sensor(0x66,0xe5); //fa
	  SP0A19_write_cmos_sensor(0x67,0x78); //72
	  SP0A19_write_cmos_sensor(0x68,0x98); //8a
	//indoor
	  SP0A19_write_cmos_sensor(0x69,0xa5); //83 c6
	  SP0A19_write_cmos_sensor(0x6a,0xd5); //b3 ee
	  SP0A19_write_cmos_sensor(0x6b,0x99); //b8 94
	  SP0A19_write_cmos_sensor(0x6c,0xca); //e8 ab
	//f 
	  SP0A19_write_cmos_sensor(0x61,0x67); //7a
	  SP0A19_write_cmos_sensor(0x62,0x85); //98
	  SP0A19_write_cmos_sensor(0x63,0xc0); //c5
	  SP0A19_write_cmos_sensor(0x64,0xdf); //e6
	  //cwf
	  SP0A19_write_cmos_sensor(0x6d,0xaa); //b9
	  SP0A19_write_cmos_sensor(0x6e,0xcf); //de
	  SP0A19_write_cmos_sensor(0x6f,0xb5); //b2
	  SP0A19_write_cmos_sensor(0x70,0xd9); //d5
	...
	//skin detect
	 ...
	 SP0A19_write_cmos_sensor(0x0f,0x50);//0x5f	0813
	...
	//smooth
	  ...
	  SP0A19_write_cmos_sensor(0x9d,0x12); //raw_grgb_thr_lowlight
		//Gr\Gb
	  SP0A19_write_cmos_sensor(0x81,0xa0);//0xa0 //raw_gflt_fac_outdoor
	  SP0A19_write_cmos_sensor(0x82,0xa0);//0x80 //raw_gflt_fac_normal
	  SP0A19_write_cmos_sensor(0x83,0xa0);//0x40 //raw_gflt_fac_dummy
	  SP0A19_write_cmos_sensor(0x84,0xa0);//0x30 //raw_gflt_fac_lowlight
		//GrGb                              //    
	  SP0A19_write_cmos_sensor(0x85,0xa0);//0xa0 //raw_gf_fac_outdoor  
	  SP0A19_write_cmos_sensor(0x86,0xa0);//0x80 //raw_gf_fac_normal  
	  SP0A19_write_cmos_sensor(0x87,0xa0);//0x40 //raw_gf_fac_dummy   
	  SP0A19_write_cmos_sensor(0x88,0xa0);//0x30 //raw_gf_fac_lowlight
		//
	...
	//sharpen 
	  ...
	  SP0A19_write_cmos_sensor(0xe5,0x06); //rangek_neg_outdoor  //0x08
	  SP0A19_write_cmos_sensor(0xd3,0x06); //rangek_pos_outdoor	//0x08
	  SP0A19_write_cmos_sensor(0xd7,0x06); //range_base_outdoor	//0x08
	 
	  SP0A19_write_cmos_sensor(0xe6,0x06); //rangek_neg_normal   // 0x08
	  SP0A19_write_cmos_sensor(0xd4,0x06); //rangek_pos_normal   // 0x08
	  SP0A19_write_cmos_sensor(0xd8,0x06); //range_base_normal   // 0x08
	  
	  SP0A19_write_cmos_sensor(0xe7,0x0c); //rangek_neg_dummy   // 0x10
	  SP0A19_write_cmos_sensor(0xd5,0x0c); //rangek_pos_dummy   // 0x10
	  SP0A19_write_cmos_sensor(0xd9,0x0c); //range_base_dummy    // 0x10
		
	  SP0A19_write_cmos_sensor(0xd2,0x14); //rangek_neg_lowlight
	  SP0A19_write_cmos_sensor(0xd6,0x14); //rangek_pos_lowlight
	  SP0A19_write_cmos_sensor(0xda,0x14); //range_base_lowlight
	 
	  SP0A19_write_cmos_sensor(0xe8,0x20);  //sharp_fac_pos_outdoor  // 0x35
	  SP0A19_write_cmos_sensor(0xec,0x30);  //sharp_fac_neg_outdoor
	  SP0A19_write_cmos_sensor(0xe9,0x1c);  //sharp_fac_pos_nr	  // 0x35
	  SP0A19_write_cmos_sensor(0xed,0x25);  //sharp_fac_neg_nr
	  SP0A19_write_cmos_sensor(0xea,0x18);  //sharp_fac_pos_dummy   // 0x30
	  SP0A19_write_cmos_sensor(0xef,0x28);  //sharp_fac_neg_dummy   // 0x20
	...
	//CCM
	  ...
	  SP0A19_write_cmos_sensor(0xa3,0xfa);  // 0xf6
	  SP0A19_write_cmos_sensor(0xa4,0x86);  // 0x99
	  ...
	  SP0A19_write_cmos_sensor(0xfd,0x00);
			...
			//gamma  
	  SP0A19_write_cmos_sensor(0xfd ,0x00);
	  SP0A19_write_cmos_sensor(0x8b ,0x00);  // 00;0 ;0 
	  SP0A19_write_cmos_sensor(0x8c ,0x0c);  // 0f;C ;11
	  SP0A19_write_cmos_sensor(0x8d ,0x17);  // 1e;19;19
	  SP0A19_write_cmos_sensor(0x8e ,0x27);  // 3d;2C;28
	  SP0A19_write_cmos_sensor(0x8f ,0x44);  // 6c;49;46
	  SP0A19_write_cmos_sensor(0x90 ,0x5b);  // 92;61;61
	  SP0A19_write_cmos_sensor(0x91 ,0x70);  // aa;77;78
	  SP0A19_write_cmos_sensor(0x92 ,0x84);  // b9;8A;8A
	  SP0A19_write_cmos_sensor(0x93 ,0x94);  // c4;9B;9B
	  SP0A19_write_cmos_sensor(0x94 ,0xa2);  // cf;A9;A9
	  SP0A19_write_cmos_sensor(0x95 ,0xae);  // d4;B5;B5
	  SP0A19_write_cmos_sensor(0x96 ,0xba);  // da;C0;C0
	  SP0A19_write_cmos_sensor(0x97 ,0xc4);  // e0;CA;CA
	  SP0A19_write_cmos_sensor(0x98 ,0xd0);  // e4;D4;D4
	  SP0A19_write_cmos_sensor(0x99 ,0xd7);  // e8;DD;DD
	  SP0A19_write_cmos_sensor(0x9a ,0xe1);  // ec;E6;E6
	  SP0A19_write_cmos_sensor(0x9b ,0xe9);  // f1;EF;EF
	  SP0A19_write_cmos_sensor(0xfd ,0x01);  // 01;01;01
	  SP0A19_write_cmos_sensor(0x8d ,0xf2);  // f7;F7;F7
	...
	//ae target
	  ...
	  SP0A19_write_cmos_sensor(0xf8,0x70); //70 
	  SP0A19_write_cmos_sensor(0xec,0x6c); //6c  
	...
	//lowlight lum
	  SP0A19_write_cmos_sensor(0xfd,0x00); //
	  SP0A19_write_cmos_sensor(0xb2,0x18); //lum_limit  // 0x10
	...
	//saturation
	  ...
	  SP0A19_write_cmos_sensor(0xd3,0x80);//88 //0x78
	  SP0A19_write_cmos_sensor(0xd4,0x80);//88 //0x78
	  SP0A19_write_cmos_sensor(0xd6,0x7a);//85 //0x78 	   (0xd7,0x60); //0x78
	  SP0A19_write_cmos_sensor(0xd7,0x70);//70

	//HEQ
	  SP0A19_write_cmos_sensor(0xfd,0x00); 
	  SP0A19_write_cmos_sensor(0xdc,0x00); 
	  SP0A19_write_cmos_sensor(0xdd,0x80); //0x80 0813  // 0x78
	  SP0A19_write_cmos_sensor(0xde,0x90); //80  0x88  0813
	...
	//func enable
	  ...
	  SP0A19_write_cmos_sensor(0x35,0x01);  
	  SP0A19_write_cmos_sensor(0x33,0xff);  //ef
	  SP0A19_write_cmos_sensor(0x5f,0x51); 
	  SP0A19_write_cmos_sensor(0xf4,0x0b); //0x0b AE speed
...
BOOL SP0A19_set_param_effect(UINT16 para)
{
	...
	/*Lenovo-sw chenglong1 add for color effect switch display issue*/
	unsigned char pclk_regval=0;
	pclk_regval = SP0A19_read_cmos_sensor(0x30);
	SP0A19_write_cmos_sensor(0x30, pclk_regval | 0x80);
	/*Lenovo-sw add end*/
	...
	/*Lenovo-sw chenglong1 add for color effect switch display issue*/
	mdelay(50);
	SP0A19_write_cmos_sensor(0x30, pclk_regval);
	/*Lenovo-sw add end*/
...
void SP0A19_set_saturation(UINT16 para)
{
    switch (para)
    {
        ...
        case ISP_SAT_HIGH:
			...
			SP0A19_write_cmos_sensor(0xd6,0x85+0x20); //dummy
        ...
        case ISP_SAT_LOW:
			...
			SP0A19_write_cmos_sensor(0xd6,0x85-0x20); 
        ...
        default:
			...
			SP0A19_write_cmos_sensor(0xd6,0x85); 
