...
#define CS_PART_NUMBER[0]       H9TP18A8JDMCPR_KGM    //lenovo.sw : add to support 1+16G hynix emmc for scofield td
#define CS_PART_NUMBER[1]       KMK8X000VM_B412 //lenovo.sw jixj : add to support 1+16G samsung emmc for phaeton 
