...
#define CS_PART_NUMBER[0]         KMI8U000MA_B605  //mtk's temply timing, KMI8U000MA-B605 , we use it temply .
//#define CS_PART_NUMBER[0]       H9TP32A8JDACPR_KGM
#define CS_PART_NUMBER[1]       KMK7X000VM_B314 //liaohj add for 2 mcp 2014-03-24
