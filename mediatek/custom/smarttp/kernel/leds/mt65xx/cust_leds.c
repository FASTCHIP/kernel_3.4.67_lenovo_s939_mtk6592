 ...
 *-------------------------------------------------------------------------------------------
 */
#ifdef LENOVO_LCM_CABC
extern int DISP_SetBacklight(unsigned int level);
#endif
 
 static struct cust_mt65xx_led cust_led_list[MT65XX_LED_TYPE_TOTAL] = {
	{"red",               MT65XX_LED_MODE_NONE, -1,{0}},
//lenovo.sw2 houdz1 add for support "greenled" 20130930
	{"greenled",             MT65XX_LED_MODE_PMIC, MT65XX_LED_PMIC_NLED_ISINK1,{0}},
//lenovo.sw2 houdz1 add for support "factory mode" 20131023 
/* Lenovo-sw yexm1, modify for use LP5560, 20140401, begin */
	#if defined (LENOVO_LP5560_SUPPORT)
	{"blue",              MT65XX_LED_MODE_CUST, -1,{0}},
	{"test-led",             MT65XX_LED_MODE_PMIC, MT65XX_LED_PMIC_NLED_ISINK1,{0}},
	#else
	{"blue",              MT65XX_LED_MODE_NONE, -1,{0}},
	#endif
/* Lenovo-sw yexm1, modify for use LP5560, 20140401, end */
	{"jogball-backlight", MT65XX_LED_MODE_NONE, -1,{0}},
	{"keyboard-backlight",MT65XX_LED_MODE_NONE, -1,{0}},
	{"button-backlight",  MT65XX_LED_MODE_PMIC, MT65XX_LED_PMIC_NLED_ISINK0,{0}},//Lenovo-sw yexm1 modify 20140415
#ifdef LENOVO_LCM_CABC //lenovo.sw2 houdz1 add for "lcm CABC"
	{"lcd-backlight",     MT65XX_LED_MODE_CUST_BLS_PWM, (int)DISP_SetBacklight,{0}},
#else
