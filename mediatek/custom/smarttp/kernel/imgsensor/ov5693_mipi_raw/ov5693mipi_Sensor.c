...
UINT32 OV5693MIPIGetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
    ...
    pSensorResolution->SensorPreviewWidth = OV5693MIPI_IMAGE_SENSOR_FULL_WIDTH;//OV5693MIPI_IMAGE_SENSOR_PV_WIDTH;
    pSensorResolution->SensorPreviewHeight = OV5693MIPI_IMAGE_SENSOR_FULL_HEIGHT;//OV5693MIPI_IMAGE_SENSOR_PV_HEIGHT;
