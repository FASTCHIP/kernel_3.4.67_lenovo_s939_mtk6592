...
//#define CS_PART_NUMBER[0]       H9TP32A8JDACPR_KGM   //lenovo.sw : delete mtk default 1+4 hynix emmc , lenovo don't use it
#define CS_PART_NUMBER[0]       KMK7U000VM_B309    //lenovo.sw : add to support 1+8G samsung emmc  for sella and sofina
#define CS_PART_NUMBER[1]       H9TP65A8JDACPR_KGM    //lenovo.sw : add to support 1+8G hynix emmc  for stella
