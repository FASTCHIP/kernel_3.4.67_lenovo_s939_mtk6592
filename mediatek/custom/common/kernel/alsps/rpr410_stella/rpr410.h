...
#define COEFFICIENT               (7)
const unsigned long data0_coefficient[COEFFICIENT] = {1630, 1650, 1050, 750,410,90,40};
const unsigned long data1_coefficient[COEFFICIENT] = {2567, 2667,  1167,  712, 293, 2, 10};
const unsigned long judge_coefficient[COEFFICIENT] = { 2,  4,  7, 8,11,40,100};
...
#define PS_ALS_SET_ALSPS_CONTROL  (LEDCURRENT_100MA | ALSGAIN_X1X1) //(LEDCURRENT_200MA | ALSGAIN_X128X128)  //LEDCURRENT_200MA ALSGAIN_X1X1
