...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.horizontal_sync_active				= 15;//0x12;// 50  2
		params->dsi.horizontal_backporch				= 50;//0x49;
		params->dsi.horizontal_frontporch				= 50;//0x49;
		params->dsi.horizontal_active_pixel				= FRAME_WIDTH;
		params->dsi.PLL_CLOCK=216; //230;        /*lenovo.sw 20130905d wangsx3 change mipi clock*/
		...
		cycle_time=8000/(params->dsi.PLL_CLOCK*2)+0x01;
   		...
   		hs_trail_m=1;
   		hs_trail_n= (((hs_trail_m * 0x4) + 0x60-80)/cycle_time);
