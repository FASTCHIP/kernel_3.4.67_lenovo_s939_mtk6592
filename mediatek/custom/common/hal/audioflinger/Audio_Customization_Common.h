...
*****************************************************/
#ifdef LENOVO_PHAETON_HANDFREE_CALL
...
*****************************************************/
/* lenovo-sw zhouwl, 2014-02-28, for stella@s930 */
...
*****************************************************/
#if defined(DRC_2_0_HEADSET_SUPPORT) && defined(DRC_2_0_EARPHONE_SUPPORT)  //scofield_row
#define MagiLoudness_TE_mode (0x7)
#elif defined(DRC_2_0_EARPHONE_SUPPORT)    //stellap,stellaptd
#define MagiLoudness_TE_mode (0x1)
#elif defined(DRC_2_0_SPK_SUPPORT) //sofina
#define MagiLoudness_TE_mode (0x4)
#elif (defined(DRC_2_0_SPK_EARPHONE_SUPPORT) || defined(LENOVO_PHAETON_HANDFREE_CALL)) //scofield, phaeton
#define MagiLoudness_TE_mode (0x5)
#else
