...
static struct alsps_hw cust_alsps_hw = {
    ...
    .als_level  = { 1, 10, 15, 33, 38,  72,  487, 1565, 1900, 2496, 3279, 3785, 5177, 6852, 12039, 19344, 22714},
...
//#define THRES_TOLERANCE		18	//I think this is a proper value. It should not be too big.
//#define THRES_DEFAULT_DIFF	10 //15 //35
int RPR410_THRES_TOLERANCE = 18;
