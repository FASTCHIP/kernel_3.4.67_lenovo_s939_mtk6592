...
//Time
#define LENOVO_TIME_NUMBER_LEFT                  (128) 
#define LENOVO_TIME_NUMBER_RIGHT                 (128+63)
#define LENOVO_TIME_NUMBER_TOP                   (132)
#define LENOVO_TIME_NUMBER_BOTTOM                (132+105)
// : colon
#define LENOVO_TIME_COLON_LEFT                 (128+63+63) 
#define LENOVO_TIME_COLON_RIGHT                (128+63+63+32)
#define LENOVO_TIME_COLON_TOP                  (132)
#define LENOVO_TIME_COLON_BOTTOM               (132+105)

//Date
#define LENOVO_DATE_NUMBER_LEFT                  (195) 
#define LENOVO_DATE_NUMBER_RIGHT                 (195+15)
#define LENOVO_DATE_NUMBER_TOP                   (132+105+20)
#define LENOVO_DATE_NUMBER_BOTTOM                (132+105+20+28)
// : horiz
#define LENOVO_DATE_HORIZ_LEFT                 (195+15*4) 
#define LENOVO_DATE_HORIZ_RIGHT                (195+15*5)
#define LENOVO_DATE_HORIZ_TOP                  (132+105+20)
#define LENOVO_DATE_HORIZ_BOTTOM               (132+105+20+28)

// Battery
#define LENOVO_CAPACITY_LEFT                (201) // battery capacity center
#define LENOVO_CAPACITY_RIGHT               (201+138)
#define LENOVO_CAPACITY_TOP                 (542)
#define LENOVO_CAPACITY_BOTTOM              (542+180)
// top animation part
#define LENOVO_TOP_ANIMATION_LEFT           (201) // top animation
#define LENOVO_TOP_ANIMATION_RIGHT          (201+138)
#define LENOVO_TOP_ANIMATION_TOP            (542+160)
#define LENOVO_TOP_ANIMATION_BOTTOM         (542+180)

// above 90
#define LENOVO_CAPACITY_ABOVE_90_LEFT           (201) // top animation
#define LENOVO_CAPACITY_ABOVE_90_RIGHT          (201+138)
#define LENOVO_CAPACITY_ABOVE_90_TOP            (542+20-2)
#define LENOVO_CAPACITY_ABOVE_90_BOTTOM         (542+20)


//must modify debug liao
//Capacity num
#define LENOVO_CAPACITY_NUMBER_LEFT                  (248-15+30) 
#define LENOVO_CAPACITY_NUMBER_RIGHT                 (248-15+30+15)
#define LENOVO_CAPACITY_NUMBER_TOP                   (542+200+25)
#define LENOVO_CAPACITY_NUMBER_BOTTOM                (542+200+25+27)
// : logo
#define LENOVO_CAPACITY_LOGO_LEFT                 (248-15) 
#define LENOVO_CAPACITY_LOGO_RIGHT                (248-15+30)
#define LENOVO_CAPACITY_LOGO_TOP                  (542+200+25)
#define LENOVO_CAPACITY_LOGO_BOTTOM               (542+200+25+27)

// %  rectangle
#define LENOVO_CAPACITY_PERCENT_LEFT                 (248-15+30+30) // percent number_left + 2*number_width
#define LENOVO_CAPACITY_PERCENT_RIGHT                (248-15+30+30+15)
#define LENOVO_CAPACITY_PERCENT_TOP                (542+200+25)
#define LENOVO_CAPACITY_PERCENT_BOTTOM               (542+200+25+27)

//Charing animation
#define LENOVO_CHARGING_ANI_LEFT                 (248) // percent number_left + 2*number_width
#define LENOVO_CHARGING_ANI_RIGHT                (248+45)
#define LENOVO_CHARGING_ANI_TOP                  (542+200+25+27+10)
#define LENOVO_CHARGING_ANI_BOTTOM               (542+200+25+27+10+140)
