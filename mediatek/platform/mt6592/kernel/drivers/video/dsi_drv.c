...
#ifdef LENOVO_LCM_MULTI_GAMMA_PQ  //lenovo.sw2 houdz 20140227 add:support  "Multi Gamma" function
...
/* Lenovo-sw yexm1 add for esd_check, 20140401 begin*/
#if defined(LENOVO_LCM_ESD_HS_READ)
void Lenovo_set_HS_read()
{
...
#endif
/* Lenovo-sw yexm1 add for esd_check, 20140401 end*/
